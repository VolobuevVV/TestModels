...
model2_path = r"C:\Users\vladi\Downloads\g_11n_224_150ep.pt"  # Укажи вторую модель
...
for image_path in image_paths:
    ...
    annotated_img1 = results1[0].plot()  # Первая модель
    annotated_img2 = results2[0].plot()  # Вторая модель
    ...
    plt.suptitle(os.path.basename(image_path))  # Имя файла в заголовке
    plt.show()
